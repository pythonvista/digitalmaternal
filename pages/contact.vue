    ...
    <div class="max-w-6xl px-4 mx-auto sm:px-6 lg:px-8">
      ...
      >
        <div class="flex flex-col justify-between lg:py-5">
          <div>
            <h2
              class="text-3xl font-bold leading-tight text-white sm:text-4xl lg:leading-tight lg:text-5xl"
            >
              Become A Volunteer
            </h2>
            <p
        ...
        <div class="lg:pl-12">
          <div class="overflow-hidden bg-white rounded-md">
            <div class="p-6 sm:p-10">
              <h3 class="text-3xl font-semibold text-black">Join Us</h3>
              <p class="mt-4 text-base text-gray-600">
                Become a volunteer, together We Can Change The World!
              </p>
              ...
              <form action="#" method="POST" class="mt-4">
                <div class="space-y-6">
                  ...
                  <div>
                    <button
                      type="submit"
                      class="inline-flex items-center justify-center w-full px-4 py-4 text-base font-semibold text-white transition-all duration-200 bg-purple-500 border border-transparent rounded-md focus:outline-none hover:bg-purple-600 focus:bg-purple-600"
                    >
                      Get Free Quote
                    </button>
                  </div>
        ...
        <div class="md:hidden">
          ...
          <div class="flex items-center mt-8">
            <img
              class="flex-shrink-0 object-cover w-10 h-10 rounded-full"
              src="https://i.imgur.com/JwjsvzS.jpeg"
              alt=""
            />
            <div class="ml-4">
              <p class="text-base font-semibold text-white">ODION</p>
              <p class="mt-px text-sm text-gray-400">C.E.O</p>
            </div>
          </div>
        </div>
      </div>
